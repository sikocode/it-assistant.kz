...
<!--<h3 class="h3">Заполнете заявку</h3>	
<form method="post">	 
		<p>ФИО:
...
<h3 class="h3">Заполнете заявку2</h3>
<form method="post">
<ul class="border">
  <li><p>ФИО:<input type="text" name="fio" /></p></li>
  <li><p>Телефон:<input type="text" name="phone" /></p></li>
  <li><p>Email:<input type="text" name="email" /></p></li>
  <li><p>Text:<input type="text" name="text_sms"/></p></li>
  ...
  <div class="container">
    <section>
      <form>
        <label>
          <input name="name" id="name" type="text" required />
          <div class="label-text">Ф.И.О.</div>
        </label>
        <label>
          <input type="email" name="email" id="email" required />
          <div class="label-text">Email</div>
		...
		<label>
          <input type="text" name="text_sms" id="text_sms" required />
